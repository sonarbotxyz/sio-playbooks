---
title: "SQL"
description: "Guide ultime SQL pour le BTS SIO SLAM"
category: "Bases de donnees"
tags: ["sql", "mysql", "requetes", "jointures"]
...
1. [Introduction aux bases de donnees relationnelles](#1-introduction-aux-bases-de-donnees-relationnelles)
2. [Creation de base et de tables (DDL)](#2-creation-de-base-et-de-tables-ddl)
3. [Insertion, modification, suppression (DML)](#3-insertion-modification-suppression-dml)
4. [SELECT -- Les requetes de lecture](#4-select--les-requetes-de-lecture)
5. [Jointures](#5-jointures)
6. [Sous-requetes](#6-sous-requetes)
7. [Vues](#7-vues)
8. [Index](#8-index)
