...
2. [1. Menaces et vulnérabilités](#1-menaces-et-vulnrabilits)
3. [2. Principes de sécurité](#2-principes-de-scurit)
4. [3. Pare-feu : concepts et types](#3-pare-feu-concepts-et-types)
5. [4. pfSense](#4-pfsense)
6. [5. DMZ](#5-dmz)
7. [6. VPN](#6-vpn)
8. [7. OpenVPN en pratique](#7-openvpn-en-pratique)
9. [8. Proxy et filtrage web](#8-proxy-et-filtrage-web)
10. [9. IDS/IPS](#9-idsips)
11. [10. Chiffrement](#10-chiffrement)
12. [11. PKI et certificats](#11-pki-et-certificats)
13. [12. SSL/TLS](#12-ssltls)
14. [13. Durcissement des systèmes](#13-durcissement-des-systmes)
15. [14. Analyse de logs](#14-analyse-de-logs)
16. [15. Wi-Fi sécurisé](#15-wi-fi-scuris)
17. [16. Exercices corrigés](#16-exercices-corrigs)


Ce playbook couvre l'ensemble des connaissances requises en sécurité des infrastructures pour le BTS SIO option SISR. Il constitue une référence exhaustive allant des fondamentaux théoriques aux configurations pratiques.
...
**Enoncé** : Lors d'une analyse avec Wi