...
# PHP et MySQL -- Playbook BTS SIO SLAM

---

## Table des matieres

1. [1. Introduction a PHP](#1-introduction-a-php)
2. [2. Bases du langage PHP](#2-bases-du-langage-php)
3. [3. Chaines de caracteres](#3-chaines-de-caracteres)
4. [4. Tableaux](#4-tableaux)
5. [5. Superglobales](#5-superglobales)
6. [6. Formulaires HTML et PHP](#6-formulaires-html-et-php)
7. [7. Sessions et cookies](#7-sessions-et-cookies)
8. [8. Programmation orientee objet en PHP](#8-programmation-orientee-objet-en-php)
9. [9. Connexion MySQL avec PDO](#9-connexion-mysql-avec-pdo)
10. [10. Requetes preparees](#10-requetes-preparees)
11. [11. CRUD complet avec PDO](#11-crud-complet-avec-pdo)
12. [12. Architecture MVC en PHP](#12-architecture-mvc-en-php)
13. [13. Upload de fichiers](#13-upload-de-fichiers)
14. [14. Gestion des erreurs](#14-gestion-des-erreurs)
15. [15. Securite](#15-securite)
16. [16. Include et require](#16-include-et-require)
17. [17. Pagination des resultats](#17-pagination-des-resultats)
18. [18. Exercices d'examen corriges](#18-exercices-dexamen-corriges)
19. [Recapitulatif des points essentiels pour l'examen](#recapitulatif-des-points-essentiels-pour-lexamen)
