...
1. [1. Commutation -- Fonctionnement d'un switch](#1-commutation-fonctionnement-dun-switch)
2. [2. VLANs (Virtual Local Area Networks)](#2-vlans-virtual-local-area-networks)
3. [3. Protocole STP (Spanning Tree Protocol)](#3-protocole-stp-spanning-tree-protocol)
4. [4. Principes du routage](#4-principes-du-routage)
5. [5. Routage statique](#5-routage-statique)
6. [6. Routage dynamique](#6-routage-dynamique)
7. [7. ACL (Access Control Lists)](#7-acl-access-control-lists)
8. [8. Cisco IOS -- Commandes essentielles](#8-cisco-ios-commandes-essentielles)
9. [9. Agregation de liens -- EtherChannel](#9-agregation-de-liens-etherchannel)
10. [10. Packet Tracer](#10-packet-tracer)
11. [11. Exercices corriges](#11-exercices-corriges)
12. [12. Synthese des commandes essentielles](#12-synthese-des-commandes-essentielles)
13. [13. Points de vigilance pour l'examen](#13-points-de-vigilance-pour-lexamen)


Ce playbook couvre l'ensemble des notions de commutation et de routage au programme du BTS SIO option SISR. Chaque section est conçue pour servir de reference directe lors des revisions et des epreuves pratiques.
