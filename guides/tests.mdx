...
3. [Tests de non-regression](#tests-de-non-regression)
4. [Tests d'integration](#tests-dintegration)
5. [Jeux de donnees de test](#jeux-de-donnees-de-test)
6. [TDD (Test-Driven Development) -- notions](#tdd-test-driven-development-notions)
7. [Bonnes pratiques](#bonnes-pratiques)
8. [Methodologie d'examen](#methodologie-dexamen)
9. [Exercices d'examen corriges](#exercices-dexamen-corriges)
10. [Resume des concepts cles pour l'examen](#resume-des-concepts-cles-pour-lexamen)
