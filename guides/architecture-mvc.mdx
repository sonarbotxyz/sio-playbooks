...
description: "Modele-Vue-Controleur : separation des responsabilites, implementation en JavaScript et PHP"
...
1. [1. Pourquoi une architecture ?](#1-pourquoi-une-architecture-)
2. [2. Les 3 couches MVC](#2-les-3-couches-mvc)
3. [3. Le flux MVC pas a pas](#3-le-flux-mvc-pas-a-pas)
4. [4. MVC en pratique : application Web (Express.js)](#4-mvc-en-pratique-application-web-expressjs)
5. [5. MVC en pratique : application Desktop (C# WinForms)](#5-mvc-en-pratique-application-desktop-c-winforms)
6. [6. Le pattern DAO (Data Access Object)](#6-le-pattern-dao-data-access-object)
7. [7. Variantes de MVC](#7-variantes-de-mvc)
8. [8. Avantages et inconvenients](#8-avantages-et-inconvenients)
9. [9. Methodologie d'examen](#9-methodologie-dexamen)
10. [10. Exercices d'examen corriges](#10-exercices-dexamen-corriges)
11. [Resume final](#resume-final)
