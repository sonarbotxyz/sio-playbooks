...
description: "MCD, MLD, MPD, MCT, MOT, regles de gestion, cardinalites, passage au relationnel"
...
3. [Du MCD au MLD (Modele Logique de Donnees)](#du-mcd-au-mld-modele-logique-de-donnees)
4. [Du MLD au MPD (Modele Physique de Donnees)](#du-mld-au-mpd-modele-physique-de-donnees)
...
8. [Resume des regles de transformation MCD vers MLD](#resume-des-regles-de-transformation-mcd-vers-mld)
9. [Resume des types SQL courants pour l'examen](#resume-des-types-sql-courants-pour-lexamen)
10. [Lexique](#lexique)
